...
exports.GetFoodByID = exports.GetFoods = exports.AddFood = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ message: "No food available." })];
            case 2: return [2 /*return*/, res.json({ message: "Foods information not found." })];
        }
    });
}); };
exports.GetFoods = GetFoods;
var GetFoodByID = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, food;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.user;
                if (!user) return [3 /*break*/, 2];
                return [4 /*yield*/, models_1.Food.findById(req.params.id)];
            case 1:
                food = _a.sent();
                if (food !== null)
                    return [2 /*return*/, res.json(food)];
                return [2 /*return*/, res.json({ message: "Food information not found." })];

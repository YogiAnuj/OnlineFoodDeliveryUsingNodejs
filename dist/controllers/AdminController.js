...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, ownerName, foodType, pincode, address, email, phone, password, foods, checkVendor, salt, hashedPassword, createVendor;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, ownerName = _a.ownerName, foodType = _a.foodType, pincode = _a.pincode, address = _a.address, email = _a.email, phone = _a.phone, password = _a.password, foods = _a.foods;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.json({ message: "Vendor data not found." })];
        }
    });
}); };
...
var GetVendorByID = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.findVendor(req.params.id)];
            case 1:
                vendor = _a.sent();
                if (vendor !== null) {
